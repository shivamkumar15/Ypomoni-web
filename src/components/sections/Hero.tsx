  ...
  return (
    <section ref={sectionRef} id="top" className="relative h-[125vh] w-full overflow-hidden bg-ink">
      ...
      <div className="sticky top-0 flex h-screen items-center justify-center">
        <div ref={contentRef} className="relative z-10 mx-auto flex max-w-4xl flex-col items-center px-6 text-center will-change-transform">
          <div className="mb-7 inline-flex items-center gap-2.5 rounded-full glass px-4 py-2 text-sm font-medium text-white/80">
            <span className="relative flex h-2.5 w-2.5">
              ...
              <span className="relative inline-flex h-2.5 w-2.5 rounded-full bg-[#ff3f68]" />
            </span>
          ...
          <p className="mt-7 max-w-2xl text-pretty text-lg leading-8 text-white/65 md:text-xl md:leading-9">
          ...
          <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row">
            <a
              href="#how-it-works"
              className="group inline-flex items-center justify-center gap-2 rounded-full bg-[#ff3f68] px-7 py-4 text-sm font-semibold text-black shadow-[0_0_40px_-8px_rgba(255,63,104,0.7)] transition hover:scale-[1.04] hover:bg-[#ff5a7f]"
            >
              See how it works
            ...
            <a
              href="#download"
              className="inline-flex items-center justify-center rounded-full glass px-7 py-4 text-sm font-semibold text-white transition hover:bg-white/10"
            >
              Get the app
            </a>
          </div>
          ...
          <div className="mt-14 grid w-full max-w-2xl grid-cols-3 gap-3">
            {[
              ...
              <div key={metric} className="rounded-2xl glass px-4 py-5 text-center">
        ...
        <div ref={hintRef} className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-white/40">
