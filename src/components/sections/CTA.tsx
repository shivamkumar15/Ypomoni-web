...
export function CTA() {
  return (
    <section id="download" className="relative w-full overflow-hidden bg-ink py-28 md:py-36">
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-[70vh] w-[70vh] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#ff3f68]/12 blur-[130px]" />
      <div className="mx-auto max-w-7xl px-6 md:px-10 lg:px-12">
        <Reveal className="relative overflow-hidden rounded-[2.5rem] border border-[#ff3f68]/20 bg-gradient-to-br from-[#1a0a12] via-ink-card to-ink p-10 md:p-16">
          ...
          <div className="relative mx-auto max-w-3xl text-center">
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <a href="#" className="group flex w-full items-center justify-center gap-3 rounded-2xl bg-white px-6 py-4 text-black transition hover:scale-[1.03] sm:w-auto">
                ...
                <div className="text-left">
                  <p className="text-[10px] font-semibold uppercase tracking-wider opacity-60">Download on the</p>
                  <p className="-mt-0.5 font-display text-lg font-bold">App Store</p>
                </div>
              </a>
              <a href="#" className="group flex w-full items-center justify-center gap-3 rounded-2xl glass px-6 py-4 text-white transition hover:scale-[1.03] sm:w-auto">
                ...
                <div className="text-left">
                  <p className="text-[10px] font-semibold uppercase tracking-wider text-white/60">Get it on</p>
      ...
      <footer id="contacts" className="mx-auto mt-24 max-w-7xl px-6 md:px-10 lg:px-12">
        <div className="grid gap-10 border-t border-white/10 pt-12 md:grid-cols-[1.5fr_1fr_1fr_1fr]">
          <div>
          ...
          {[
            ...
            <div key={col.title}>
              <p className="font-display text-sm font-bold uppercase tracking-wider text-white/80">{col.title}</p>
              <ul className="mt-4 space-y-2.5">
                {col.links.map((link) => (
                  <li key={link}>
                    <a href="#" className="group inline-flex items-center gap-1 text-sm text-white/45 transition hover:text-white">
                      {link}
        ...
        <div className="flex flex-col items-center justify-between gap-4 border-t border-white/10 py-8 sm:flex-row">
          <p className="text-xs text-white/35">© {new Date().getFullYear()} Ypomoni. All rights reserved.</p>
          <SocialFlipButton />
          <p className="text-xs text-white/35">Designed for the moments that matter.</p>
        </div>
      </footer>
    </section>
  )
